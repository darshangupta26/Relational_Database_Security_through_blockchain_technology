...
public class MySQLDBInserter {
     ...
     public boolean insertData(Statement st, String tablename,LinkedList values)
    {
      ...
      public boolean insertIntegityinfo(Statement st,String tablename, String attname, String datetime)
    {
        ...
        try
        {
            ...
            String query="Insert into integrityinfo values('"+tablename+"','"+attname+"','"+datetime+"')";
